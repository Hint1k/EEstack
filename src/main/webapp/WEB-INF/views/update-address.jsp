...
<form method="post" action="${pageContext.request.contextPath}/api/addresses/${address.id}">
  <input type="hidden" name="_method" value="PUT"/>  <!-- Hidden field to simulate PUT -->
  <input type="hidden" name="id" value="${address.id}"/> <!-- Ensure the address ID is sent -->
